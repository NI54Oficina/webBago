...
foreach($model as $producto){
	...
	echo " <td><a href='".Yii::app()->getBaseUrl(true)."/seccion/view/".$producto->id."'>Ver </a>";
	
		echo "<a href='".Yii::app()->getBaseUrl(true)."/seccion/update/".$producto->id."'>Update </a>";
	
			echo "<p class='delete' href='".Yii::app()->getBaseUrl(true)."/seccion/delete/".$producto->id."'>Delete </p>";
	echo "</td></tr>";
}
