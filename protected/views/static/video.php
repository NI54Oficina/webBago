   <!-- BigVideo Dependencies -->
	...
	<div class=" col-lg-6 col-md-6 col-sm-6 col-xs-6 redes-home-video">
		...
		<div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin:auto; text-align:center" align="center"><img style="margin-right: 1%"src="<?php echo Yii::app()->request->baseUrl; ?>/img/logo-blanco.png" alt="logo-bago"  class="logo-blanco" />		<div  class="border-video"></div></div>
