<section>
			<div class="header-layout-aftosa col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<h1 class="titulo-layout-aftosa">Lucha contra aftosa</h1>
			</div>
	</section>
...
<div class="hidden-sm hidden-xs">
	...
	<div class="tabla-aftosa col-lg-10 col-md-10 col-sm-12 col-xs-12">
	
		<div  class="tr  col-lg-10 col-md-10 col-sm-12 col-xs-12" style="text-shadow:none;">			
				<p style=""><strong>Nuestra compañía es reconocida en el mundo por su principal aporte en el control de la Fiebre Aftosa y por su integración en el trabajo con organismos públicos e instituciones científicas internacionales.  <br />
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">	
		<div class="tr">
			<div>
				<p style="line-height: 43px; text-shadow: 4px 3px black;font-size: 30px;">Hoy somos la  única compañía en Sudamérica en tener registrada su vacuna en todos los países de la  región, con planes de vacunación contra la enfermedad:  4 de cada 10 bovinos reciben la vacuna de Biogénesis Bagó.
				</p>
			</div>
		</div>
	</div>
	...
	<!-- DIV AÑOS -->
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
		<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 div-años-aftosa-1">
		...
		<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12  div-años-aftosa-2">
	...
	<!-- DIV AÑOS -->
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
		<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 div-años-aftosa-3">
		...
		<div  class="col-lg-6 col-md-6 col-sm-12 col-xs-12 div-años-aftosa-4">
...
<div class="div-texto-aftosa col-lg-9 col-md-9 col-sm-11 col-xs-11 hidden-lg hidden-md" style="margin-top:-25%">
	
			<h2 class="h2-aftosa hidden-md hidden-lg" style="font-size: 33px;">Institucional <br /><br /></h2>
	<!-- TITULO SECCIÓN -->
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
		...
		<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12  div-años-aftosa-2" style="margin-top:5%;padding:0;">
			<h3 class="h3-aftosa"><strong><span  class="span-aftosa">A</span>ÑO 2000</strong></h3>
				<p class="p-aftosa" >En  el año 2000, pusimos en funcionamiento el <strong>primer Banco Regional de Antígenos, vacunas anti Aftosa y Reserva Tecnológica</strong>.
	...
	<!-- DIV AÑOS -->
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
		<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 div-años-aftosa-3" style="margin-top:5%;padding:0;">
		    <h3 class="h3-aftosa"><strong><span  class="span-aftosa">A</span>ÑO 2006</strong></h3>
				<p class="p-aftosa" >Desde 2006 el laboratorio es proveedor del <strong>Banco de Antígenos de Estados Unidos, México y Canadá</strong>. 
				</p>
		</div>
		
		<div  class="col-lg-6 col-md-6 col-sm-12 col-xs-12 div-años-aftosa-4" style="margin-top:5%;padding:0;">
			<h3 class="h3-aftosa"><strong><span  class="span-aftosa">A</span>ÑO 2010</strong></h3>
				<p class="p-aftosa" >En  2010, obtuvimos la licencia para uso y comercialización, en caso de emergencia, de la <strong>vacuna anti Aftosa en Canadá</strong>.
				</p>
		</div>
